...
\title{Enhancing Reliabilty and Controllability in Generative Models through Domain-informed Constraints}  % Title of the thesis.
\author{He CAO}     % Author of the thesis.
...
\subject{Individualized Interdisciplinary Program (Artificial Intelligence)} % Subject of the Degree.
\department{Division of Emerging Interdisciplinary Areas}       % Department to which the thesis is submitted.
\advisor{Prof. Yuan YAO}     % Supervisor. Additional co-supervisor can be added using \member
%\acting      % Uncomment for Accting department head
\coadvisor{Prof. Yangqiu SONG}
